...
const OnBoarding2 = () => {
  ...
  return (
    <View style={styles.onBoarding3}>
      ...
      />
      <Text style={[styles.editingMadeEasy, styles.editingMadeEasyFlexBox]}>
        Editing Made Easy
      </Text>
      <Text style={[styles.fineTuneYourVideo, styles.editingMadeEasyFlexBox]}>
        Fine-tune your video within the app. Add your personal touch with
