...
const OnBoarding1 = () => {
  ...
  return (
    <View style={styles.onBoarding2}>
      ...
      />
      <Text style={[styles.yourVoiceYour, styles.yourFlexBox]}>
        Your Voice, Your Story
      </Text>
      <Text style={[styles.narrateYourVideo, styles.yourFlexBox]}>
        Narrate your video yourself! The app seamlessly integrates your voice
        recording with the generated visuals.
      </Text>
